...
st.title('Transcript your Youtube video')

link = st.text_input('Enter your YouTube video link', 'https://www.youtube.com/watch?v=gDXhFrYuZ7I', on_change=refresh_state)
st.video(link)
st.video(link)

st.text('Yours Transcription is '+ st.session_state['status'])
